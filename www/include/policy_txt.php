<section class="privacy">
	...
	<ul>
		<li>
		Для улучшения обслуживания клиентов. Предоставляемая вами информация помогает нам реагировать на&nbsp;запросы клиентов более эффективно; </li>
		<li>
		Чтобы персонализировать пользовательский опыт. Мы&nbsp;можем использовать информацию для определения кто из&nbsp;посетителей Сайта наиболее заинтересован в&nbsp;услугах и&nbsp;ресурсах предоставляемых на&nbsp;нашем Сайте; </li>
		<li>
		Для улучшения нашего Сайта. Мы&nbsp;можем использовать обратную связь, которую Вы&nbsp;предоставляете, чтобы улучшить наши продукты и&nbsp;услуги; </li>
		<li>
		Для обработки платежей. Мы&nbsp;можем использовать информацию о&nbsp;пользователях при оформлении заказа для оформления платежей и&nbsp;только для этого. Мы&nbsp;не&nbsp;делимся этой информацией с&nbsp;третьими лицами, за&nbsp;исключением случаев предусмотренных законодательством РФ. </li>
		<li>
		Чтобы отправлять пользователям информацию, которую они согласились получать на&nbsp;темы, которые, как мы&nbsp;думаем, будут представлять для них интерес; </li>
		<li>
