...
//var_dump($arUser["UF_WISHLIST"]);

//var_dump(!empty($arUser["UF_WISHLIST"]));

if(!empty($arUser["UF_WISHLIST"])){
$likeFilter = array("ID" => $arUser["UF_WISHLIST"]);

?>
<div class="wrapper">
<section class="wish_page"><div class="products_grid">
