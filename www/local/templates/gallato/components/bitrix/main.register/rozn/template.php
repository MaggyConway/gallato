...
<? //echo "<pre>"; var_dump($arResult["SHOW_FIELDS"]); echo "</pre>"; ?>
	...
	<input size="30" type="password" name="REGISTER[PASSWORD]" value="<?=$arResult["VALUES"]["PASSWORD"]?>" autocomplete="off" class="bx-auth-input field" placeholder="<?=GetMessage("REGISTER_FIELD_PASSWORD")?>" />


	<input size="30" type="password" name="REGISTER[CONFIRM_PASSWORD]" value="<?=$arResult["VALUES"]["CONFIRM_PASSWORD"]?>" autocomplete="off" placeholder="<?=GetMessage("REGISTER_FIELD_CONFIRM_PASSWORD")?>" class="field" />
