...
?>
<?
	//echo '<pre>'; var_dump($arResult["ITEM"]["PROPERTIES"]["NEW"]["VALUE"]); echo '</pre>' ;



	if ($arResult["ITEM"]["PROPERTIES"]["NEW"]["VALUE"] == "Y") {
?>
...
<?}?>
	...
	<div class="prices">
		...
		<a href="<?=$arResult["ITEM"]["DETAIL_PAGE_URL"]?>" class="item__price"><?=$arResult["ITEM"]["PRICES"]["RETAIL_PRICE"]["VALUE"]?>&nbsp;Р</a>
