...
<? //echo "<pre>"; var_dump($arResult); echo "</pre>"; ?>
        ...
        <div class="bx-system-auth-form-register">
            ...
            <form class="auth-other-form" method="post" action="<?= $arResult["AUTH_URL"] ?>" name="bform" enctype="multipart/form-data">

                <input type="hidden" name="AUTH_FORM" value="Y"/>
                <input type="hidden" name="TYPE" value="REGISTRATION"/>
                <input type="hidden" name="USER_TYPE" maxlength="50" value="ROZN" class="bx-auth-input"/>
