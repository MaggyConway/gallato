...
/*ZDUyZmZYjMzYWUzM2Q1ZTE2MDhhOGE3ZTdmZDM5YjFmMTMwMDA=*/$GLOBALS['____1027504254']= array(base64_decode('ZGVmaW5l'));if(!function_exists(__NAMESPACE__.'\\___642952626')){function ___642952626($_26611782){static $_1078185766= false; if($_1078185766 == false) $_1078185766=array('RU5DT'.'0'.'RF',''.'WQ'.'==');return base64_decode($_1078185766[$_26611782]);}};class CBXFeatures{ public static function IsFeatureEnabled($_1055222103){ return true;} public static function IsFeatureEditable($_1055222103){ return true;} public static function SetFeatureEnabled($_1055222103, $_1913505908= true){} public static function SaveFeaturesSettings($_156334520, $_834467069){} public static function GetFeaturesList(){ return array();} public static function InitiateEditionsSettings($_1306955685){} public static function ModifyFeaturesSettings($_1306955685, $_1387892688){} public static function IsFeatureInstalled($_1055222103){ return true;}} $GLOBALS['____1027504254'][0](___642952626(0), ___642952626(1));/**/			//Do not remove this
