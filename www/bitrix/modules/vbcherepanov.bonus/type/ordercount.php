...
$profiles=array(
    "ORDERCOUNT",
    Loc::getMessage('VBCHBB_TYPE_ORDERCOUNT'),
    Loc::getMessage('VBCHBB_TYPE_ORDERCOUNT_DESC'),
    array(
        'TAB1'=>array(
            ...
            "ELEM"=>array(
                'FILTER'=>array(
                    'ELEMENT'=>array(
                        ...
                        'ORDERCOUNT'=>array(
                            'WIDGET'=>new ITRound\Vbchbbonus\TextWidget(),
                            "TITLE"=>'Количество заказов за ГОД (оплаченные) от',
                            'DEFAULT'=>'1',
                            "REQUIRED"=>true,
                            "TYPE"=>"string",
                        ),
                        'ORDERCOUNT1'=>array(
                            'WIDGET'=>new ITRound\Vbchbbonus\TextWidget(),
                            "TITLE"=>'Количество заказов за ГОД (оплаченные) до',
                            'DEFAULT'=>'1',
                            "REQUIRED"=>true,
                            "TYPE"=>"string",
                        ),
    ...
    'GetRules'=>function ($profileID,$Filter=array(),$arFields=array()) {
        ...
        $fltr['ORDERCOUNT'] = 'Y';
        $order_count=intval($this->GetOrderCountByUserPayPeriod($arFields['USERID'],array('PERIOD'=>'Y')));
        $flds['ORDERCOUNT']= ($order_count>=intval($Filter['ORDERCOUNT']) && $order_count<=intval($Filter['ORDERCOUNT1'])) ? 'Y' : 'N';
