...
$profiles=array(
    "ORDERX",
    Loc::getMessage('VBCHBB_TYPE_PROFILE_ORDERX_NAME'),
    Loc::getMessage('VBCHBB_TYPE_PROFILE_ORDERX_DSC'),
    array(
        'TAB1'=>array(
            ...
            "ELEM"=>array(
                'FILTER'=>array(
                    'ELEMENT'=>array(
                        ...
                        'ORDERX'=>array(
                            "WIDGET"=>new ITRound\Vbchbbonus\TextWidget(),
                            "TITLE"=>Loc::getMessage('VBCHBB_TYPE_PROFILE_ELEMENT_ORDERXNAME'),
                            "DEFAULT"=>"5",
                            'REQUIRED'=>true,
                            'PLACEHOLDER'=>Loc::getMessage('VBCHBB_TYPE_PROFILE_ELEMENT_ORDERXNAME'),
                            "TYPE"=>"string",
                            "SIZE"=>10,
                            "MAXLENGHT"=>10
                        ),
    ...
    'GetRules'=>function ($profileID,$Filter=array(),$arFields=array()) {
        ...
        $fltr['ORDERX'] = true;
        $flds['ORDERX']= (intval($arFields['USERORDERCOUNT']) % intval($Filter['ORDERX']) == 0) ;
