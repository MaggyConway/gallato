...
class CITRBBFilterGlobalCondCtrl
{
	...
	public static function GetLogic($arOperators = false)
	{
		$arOperatorsList = array(
			BT_COND_LOGIC_EQ => array(
				'ID' => BT_COND_LOGIC_EQ,
				'OP' => array(
					'Y' =>  '#FIELD# == #VALUE#',// 'in_array(#VALUE#, #FIELD#)',
					'N' => '#FIELD# == #VALUE#'
				),
				'PARENT' => ' || ',
				'MULTI_SEP' => ' || ',
...
class CITRBBFilterGlobalCondCtrlComplex extends CITRBBFilterGlobalCondCtrl
{
	public static function GetControlDescr()
	{
		$strClassName = get_called_class();
...
class CITRBBFilterGlobalCondCtrlAtoms extends CITRBBFilterGlobalCondCtrl
{
	/**
	 * @return array|bool
	 */
...
class CITRBBFilterGlobalCondCtrlGroup extends CITRBBFilterGlobalCondCtrl
{
	public static function GetControlDescr()
	{
		$className = get_called_class();
...
class CITRBBFilterCondCtrl extends CITRBBFilterGlobalCondCtrl
{
}

class CITRBBFilterCondCtrlComplex extends CITRBBFilterGlobalCondCtrlComplex
{
}

class CITRBBFilterCondCtrlGroup extends CITRBBFilterGlobalCondCtrlGroup
{
	public static function GetControlDescr()
	{
...
class CITRBBFilterCondCtrlIBlockFields extends CITRBBFilterCondCtrlComplex
{
	public static function GetControlDescr()
	{
		$description = parent::GetControlDescr();
...
class CITRBBFilterCondCtrlIBlockProps extends CITRBBFilterCondCtrlComplex
{
	public static function GetControlDescr()
	{
		$description = parent::GetControlDescr();
			...
			$arResult[$intCount]['children'][] = array(
				...
				'control' => array(
					array(
						'id' => 'prefix',
						'type' => 'prefix',
						'text' => $arOneControl['PREFIX'] ? $arOneControl['PREFIX'] :$arOneControl['LABEL']
					),
					$arLogic,
					$arValue
				)
...
class CITRBBFilterGlobalCondTree
{
...
class CITRBBFilterCatalogCondTree extends CITRBBFilterGlobalCondTree
{
	public function __construct()
	{
		parent::__construct();
...
class CITRBBFilterCondCtrlBasketProductFields extends CITRBBFilterCondCtrlIBlockFields
{
	public static function GetControlDescr()
	{
		$description = parent::GetControlDescr();
...
class CITRBBFilterCondCtrlBasketProductProps extends CITRBBFilterCondCtrlIBlockProps
{
	public static function GetControlDescr()
	{
		$description = parent::GetControlDescr();
...
class CITRBBFilterCondCtrlCatalogSettings extends CITRBBFilterGlobalCondCtrlComplex
{
	public static function GetControlDescr()
	{
		$description = parent::GetControlDescr();
