...
$MESS['SHOW_BONUS_SYSTEM']='Включить бонусную систему';
$MESS['ITR_BONUS_PATH_TO_HELP']='Путь до страницы со справкой';
$MESS['ITR_BONUS_TEXT_TO_HELP']='Наименование пункта';
?>