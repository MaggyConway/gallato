...
$MESS["STOF_LOGIN"] = "Номер телефона";
...
$MESS['BONUS_PS_BALANCE_DEFAULT']='На Вашем боусном счете: ';
$MESS['INNER_BONUS_TO_PAY']='Вы можете оплатить до ';
$MESS['INNER_BONUS_TO_PAY1']='Будет оплачено ';
$MESS['BONUS_TO_PAY']='Использовать БОНУСЫ ЗА ЗАКАЗ в качестве оплаты заказа';
$MESS['VBCH_BB_BONUS_PAY']='Оплачено бонусами:';
$MESS['VBCH_BB_BONUS_ORDER']='Бонус за заказ:';
$MESS['VBCH_BB_ACCOUNT_PAY']='Оплачено с внутреннего счета:';
?>