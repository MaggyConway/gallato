...
if($arParams['SHOW_BONUS_SYSTEM']=='Y' && $arParams['BONUS_MODULE_INSTALL']){
    $arParams['SHOW_BONUS_SYSTEM']=$arParams['SHOW_BONUS_SYSTEM']=='Y' ? 'Y' : 'N';
    $arParams['MESS_VBCH_BB_BONUS_PAY'] = Loc::getMessage('VBCH_BB_BONUS_PAY');
    $arParams['MESS_VBCH_BB_BONUS_ORDER'] = Loc::getMessage('VBCH_BB_BONUS_ORDER');
    $arParams['MESS_INNER_PS_BALANCE'] = Loc::getMessage("INNER_PS_BALANCE_DEFAULT");
    $arParams['MESS_BONUS_PS_BALANCE'] = Loc::getMessage("BONUS_PS_BALANCE_DEFAULT");
    $arParams['MESS_PAY_TO']=Loc::getMessage('INNER_BONUS_TO_PAY');
    $arParams['MESS_PAY_TO1']=Loc::getMessage('INNER_BONUS_TO_PAY1');
//    $arParams['ITR_BONUS_PATH_TO_HELP']='';
//    $arParams['ITR_BONUS_TEXT_TO_HELP']='';
}
	...
	<script>
		...
		BX.Sale.OrderAjaxComponent.init({
			...
			siteID: '<?=CUtil::JSEscape($component->getSiteId())?>',
				<?if($arParams['SHOW_BONUS_SYSTEM']=='Y' && $arParams['BONUS_MODULE_INSTALL']){?>
					bb_inner_pay:<?=CUtil::PhpToJSObject($arResult['SYSTEMPAY'])?>,
					bb_bonus_pay:<?=CUtil::PhpToJSObject($arResult['BONUSPAY'])?>,
					bb_bonus_topay:<?=CUtil::PhpToJSObject($arResult['BONUSTOPAY'])?>,
				<?}?>
