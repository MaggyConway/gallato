...
BX.BonusPay = (function()
{
	var classDescription = function(params)
	{
		...
		this.useCouponeElement = this.wrapper.getElementsByClassName('use_coupone')[0];
				...
				BX.ajax(
					{
						...
						data:
						{
							...
							buyBonus: this.inputElement.value,
							useCoupone:this.useCouponeElement.checked,
