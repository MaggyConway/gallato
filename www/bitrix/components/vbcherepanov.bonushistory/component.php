...
if ($this->StartResultCache())
{
	...
	//order pay bonus
	$arResult["PAYPART"]=$vbchbb["ORDER"]["OPTION"]["PAY"]["ACTIVE"]=="Y" ? (!strpos($vbchbb["ORDER"]["OPTION"]["PAY"]["COUNT"],"%") ? (int)CVBCHBB::declOfNum(SITE_ID,$vbchbb["ORDER"]["OPTION"]["PAY"]["COUNT"])."%" : $vbchbb["ORDER"]["OPTION"]["PAY"]["COUNT"] ): false;
