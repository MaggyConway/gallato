...
(function() {
	...
	BX.Sale.OrderAjaxComponent = {
		...
		init: function(parameters)
		{
			...
			this.bb_inner_pay=parameters.bb_inner_pay || {};
			this.bb_bonus_pay=parameters.bb_bonus_pay || {};
            this.bb_bonus_topay=parameters.bb_bonus_topay || {};
		...
		editPaySystemInfo: function(paySystemNode)
		{
			...
			/*if(this.bb_inner_pay.DISPLAY) {
				BX.adjust(BX('ACCOUNT_CNT'), {props: {disabled: this.result.PAY_CURRENT_ACCOUNT}});
			}
			if(this.bb_bonus_pay.DISPLAY) {
				BX.adjust(BX('BONUS_CNT'), {props: {disabled: this.result.PAY_BONUS_ACCOUNT}});
			}*/
		},
		...
		getInnerPaySystem: function()
		{
			...
			var isSelected = this.result.PAY_CURRENT_ACCOUNT,
				paySystem = this.result.INNER_PAY_SYSTEM,
				logotype, logoNode,subTitle, label, title, hiddenInput, htmlString, innerPsDesc,payInput,payInputH;
			if (this.params.SHOW_PAY_SYSTEM_INFO_NAME == 'Y')
			{
			...
			if(this.bb_inner_pay.USER_INPUT){
		...
		selectPaySystem: function(event)
		{
			...
			//BX.adjust(BX('ACCOUNT_CNT'), {props: {disabled: innerPaySystemCheckbox.checked}});
